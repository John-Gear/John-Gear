...
**Диплом о профессиональной переподготовке — Data Science / Big Data Specialist**  
Корпоративный университет Сбербанка, 2023

**Диплом о высшем образовании — Магистр менеджмента**  
...
README также доступен на английском языке: [README.md](./README.md)
